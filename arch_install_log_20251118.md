...
GRUB_CMDLINE_LINUX="cryptdevice=UUID=<UUID von nvme0n1p2 hier>:root zswap.enabled=0 rootfstype=btrfs"
...
- Paket gptfdisk (gdisk) installieren um Disks/Partitionen bearbeiten zu können
